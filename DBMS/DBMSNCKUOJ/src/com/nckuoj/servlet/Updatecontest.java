...
public class Updatecontest extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "update contest set Ctitle = '" + Ctitle + "', Starttime = '" + Starttime + "', Endtime = '" + Endtime + "', Status = '" + Status + "', Access = '" + Access + "', SchoolName = '" + SchoolName + "' where CID = '" + CID + "';";
