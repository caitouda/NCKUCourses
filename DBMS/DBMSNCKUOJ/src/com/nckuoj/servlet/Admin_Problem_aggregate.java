...
public class Admin_Problem_aggregate extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Admin_Problem_aggregate() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    {
			sql18 = "select count(*), sum(AC), max(AC), min(AC), avg(AC) from admin, problem where admin.Adminname = problem.AdminName;";
	        exist6 = "true";
	    }
	    if(Aggregate.equals("Try"))
	    {
			sql18 = "select count(*), sum(Try), max(Try), min(Try), avg(Try) from admin, problem where admin.Adminname = problem.AdminName;";
	        exist6 = "true";
	    }
