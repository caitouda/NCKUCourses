...
<%
    ...
    try {
        ...
        pstmt5 = conn5.prepareStatement("select * from admin;");	
        rs5 = pstmt5.executeQuery();		
        ResultSetMetaData md5 = rs5.getMetaData();
        int columnCount5 = md5.getColumnCount(); 
        out.print("<form action='insertadmin' method='post'>");
...
%>
<th width=100><input type="text" name="<%=md5.getColumnName(i).toString()%>"/>
<%        	
        }   
        out.print("</tr>");
        out.print("</table><br>");
