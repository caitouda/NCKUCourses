...
<%
    ...
    try {
        ...
        pstmt5 = conn5.prepareStatement("select distinct Status from contest;");	
...
<select name="Access" id="Access" style="width:160px; ">
...
<%
    ...
    try {
        ...
        pstmt6 = conn6.prepareStatement("select distinct Access from contest;");	
...
<select name="SchoolName" id="SchoolName" style="width:160px; ">
...
<%
    ...
    try {
        ...
        pstmt7 = conn7.prepareStatement("select distinct SchoolName from contest;");	
...
<%
    ...
    try {
        ...
        pstmt8 = conn8.prepareStatement("select * from contest;");	
        rs8 = pstmt8.executeQuery();		
        ResultSetMetaData md8 = rs8.getMetaData();
        int columnCount8 = md8.getColumnCount(); 
        out.print("<form action='insertcontest' method='post'>");
...
%>
<th width=100><input type="text" name="<%=md8.getColumnName(i).toString()%>"/>
<%        	
        }   
        out.print("</tr>");
        out.print("</table><br>");
