...
<button onclick="window.location='insertcontest.jsp';">INSERT</button><br><br>
<%
    ...
    if(exist == "true")
    {
        try {
	        ...
	        while (rs8.next()) {    
	            ...
	            CID[j] = rs8.getObject(1).toString();
%>  	            
	            <th width=100>
	              <a href="deleteByCID?CID=<%=CID[j] %>">刪除</a>
	              <a href="searchByCID?CID=<%=CID[j] %>">更新</a>
<%
                j++;
	            out.print("</tr>");
	            }  
...
<%
    ...
    try {
        ...
        out.print("<form action='updatecontest' method='post'>");
        out.print("<table border=2>");
        out.print("<tr>");
